...
client = OpenAI(api_key="2332ed28db876b7f1a700baa5a257464381df06b99e8213b4dade9a00091caa1", 
                base_url="https://api.together.xyz/v1/")

### SET THESE 4 VARIABLES ##############################

# Add your API keys here
OPENAI_API_KEY = "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"
SERPAPI_API_KEY = "cf4eed26ba5a4f51f043995902172b1e0538343008b6365b0f0cb332997a0b7e" #[optional] web-search becomes available automatically when serpapi api key is provided

# Set variables
OBJECTIVE = "write an apa format proposal titled 'impact of bullying in schools' with parenterical citations"
query_space ="impact of bullying in schools"
...
def semantic_text_completion_tool(prompt: str):
...
def semantic_research_space(query_space):
    ...
    documents = s2reader.load_data(query=query_space, 
                               limit=20, 
                               full_text=True
                              )
...
documents= semantic_research_space(query_space)

def semantic_scholar_tool(prompt):
    Settings.context_window = 70000
    # set number of output tokens
    Settings.num_output = 50000
    
    Settings.llm = Groq(temperature=0, 
                        model="mixtral-8x7b-32768", 
                        api_key="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", 
    ...
    embed_model = TogetherEmbedding(
                ...
                api_key="2332ed28db876b7f1a700baa5a257464381df06b99e8213b4dade9a00091caa1",
    ...
    #resp = text_completion_tool(f"re-output the text below the same way it was given to you without changing anything. here is the text {response}")
...
def execute_task(task, task_list, OBJECTIVE):
    ...
    if task["tool"] == "semantic-scholar":
        time.sleep(1)
        task_output = semantic_scholar_tool(task_prompt)
    elif task["tool"] == "text-completion":
...
def task_creation_agent(objective: str) -> List[Dict]:
    ...
    prompt = (
        ...
        f"Current tool options are [semantic-scholar]." # web-search is added automatically if SERPAPI exists
        ...
        #"TASK LIST=[{\"id\":1,\"task\":\"INTRODUCTION\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":2,\"task\":\"LITERACTURE REVIEW\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":3,\"task\":\"FINDINGS\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":4,\"task\":\"CONCLUSION\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":5,\"task\":\"Final summary report\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null}]"
        "TASK LIST=[{\"id\":1,\"task\":\"INTRODUCTION\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":2,\"task\":\"LITERACTURE REVIEW\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[1],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":3,\"task\":\"FINDINGS\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[2],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":4,\"task\":\"CONCLUSION\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[3],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null},{\"id\":5,\"task\":\"Final summary report\",\"tool\":\"semantic-scholar\",\"dependent_task_ids\":[1,2,3,4],\"status\":\"incomplete\",\"result\":null,\"result_summary\":null}]"
